...
\documentclass[a4paper, 12pt]{scrartcl} 								% eine alternative Klasse, um ganze Bücher zu verfassen
...
\usepackage{xargs}													% Paket zum Erstellen von Funktionen mit vielen Argumenten
...
\ifoot*{\pagemark}% add pagination to the outer part of the page footer
...
% Ideen für eine Vorwort für mein Rezeptbuch:

% Motivation hinterm Kochen?
% Essen macht auf viele Weisen Glücklich
% Alltägliche Bedarf ist eh da
% Aufwand zum Erschaffen von etwas besonderem lohnt sich
% noch besser mit Anderen oder für Andere
% stärkeres Bewusstsein von alltäglichen Ritual des Essens führt zu mehr wertschätzung, zufriedenheit und einem vernünftigeren Umgang mit Essen 

% Warum alles aufschreiben in dieser Form?
% Konservation von Erfahrung in einer möglichst verständlichen Form
% bis die Kybernetik keine effizienteren Methoden erfunden hat, bleibt Bücher schreiben die beste Art Wissen weiterzugeben und damit zu erhalten
% Sinn von einheitlicher hoffentlich verständlicher Struktur ist offensichtlich
...
\subsection{Rezeptvorlage}	\label{Rezeptlabel}
...
\section{Beilagen}
	...
	\subsection{Stangenbohnen}	\label{stangenbohnen}
	...
	\subsection{Seitan}	\label{seitan}
	...
	\subsection{Falafel}	\label{Falafel}
	...
	\subsection{Gemüse-Bratlinge}	\label{gemuese_bratlinge}
	...
	\subsection{Kartoffelknödel/Gnocchi}	\label{kartoffelknoedel}

	\begin{tabularx}{\textwidth}{r|L}
								& 	\includegraphics[height = 5cm]{media/kartoffelknoedel.jpg}	\\
								&	\\
		\textbf{Beschreibung}	&	Auch wenn ein Kartoffelteig nicht gerade wenig Arbeit ist, so bieten Kartoffelknödel und Gnocchi eine tolle Erweiterung des Einsatzbereichs der alles-könnenden Erdäpfel.  \\
								&	\\
		\begin{tabular}[t]{rr}
			\textbf{Zutaten}	\\
			\small Für 2,5 kg 			\\
			\small Für 4 Portionen (16 Knödel)	\\
		\end{tabular}			&	\begin{tabular}[t]{llll}
										2 kg (inkl. Schale) & Kartoffeln, mehlig kochend \\
										150 g & Stärke \\
										50 g & Butter \\
										2 & Eier \\
										Salz, Pfeffer, Muskat								
	...
	% für zweiseitiges Rezept entkommentieren!
		...
		\begin{tabular}[t]{rr}
			...
			\small Kochzeit:	5-15 min		\\
		\end{tabular}			&	\begin{enumerate}[]
										\item Schäle alle Kartoffeln und lege sie in ein Wasserbad um Oxidation zu verhindern. 
										\item Viertele und stelle die Hälfte der Kartoffeln in einem Topf mit Salzwasser auf den Herd.
										\item Währenddessen reibe die andere Hälfte der Kartoffeln möglichst fein.
										\item Wenn die gekochten Kartoffeln bereits weich sind, dann lasse die etwas abkühlen und zerstampfen sie zu einem Brei.
										\item Gib die geriebenen Kartoffeln in ein frisches sauberes Baumwolltuch und presse die Flüssigkeit größtenteils hinaus. Fange die Flüssigkeit auf um die Stärke daraus noch nutzen zu können.
										\item Mische die gesamten Kartoffeln mit der Stärke und würze alles mit Salz, Pfeffer und Muskat. Stelle die Teigkonsistenz mit Mehl und Stärke ein.
										\item Gib genug Wasser in einen großen Topf um ein schwimmendes Kochen zu ermöglichen, gib etwas Salz hinzu und bringe es auf dem Herd zum Kochen.
										\item Nun können entweder Knödel oder Gnocchi geformt werden.
										\item Gib die Resultate der Arbeit in den Topf zum Kochen und schöpfe sie nach 5-15 min ab, wenn sie aufschwimmen.  
									\end{enumerate}	\\
	\end{tabularx}
	\newpage


	\subsection{Aufstriche}
...
\section{Sauce}
	...
	\subsection{Béchamelsauce} \label{bechamelsauce}
	...
	\subsection{Tomatensauce}	\label{tomatensauce}
	...
	% Erdnuss-Kokos-Curry-sauce

	\subsection{Erdnuss-Kokos-Curry-Sauce}	\label{erdnuss_sauce}
...
\section{Vollständige Gerichte}
\newpage

	\subsection{Take-Away-Gerichte}
	\newpage

	\subsection{Käsespätzle}
...
% für zweiseitiges Rezept entkommentieren!
	...
	\subsection{Frikassee}	\label{frikassee}
...
% für zweiseitiges Rezept entkommentieren!
	...
	\newpage
		...
		\subsubsection{Kartoffel-Lauch-Suppe}
		...
		\subsubsection{Zwiebelsuppe}	\label{zwiebelsuppe}
		...
		\subsection{Linseneintopf}	\label{linseneintopf}
		...
		\subsection{Kartoffelpuffer}	\label{kartoffelpuffer}
		...
		\subsection{Curry-Gerichte}

			% Curry

			\subsubsection{Kokosmilch Curry}	\label{kokos_curry}
			...
			\subsubsection{Joghurt Curry}	\label{joghurt_curry}
				...
				\subsubsection{Klares Curry}	\label{klares_curry}
			...
			\subsubsection{Pav Bhaji}	\label{pav_bhaji}
			...
			\subsubsection{Kaans-Geflügel-Joghurt-Curry}	\label{kaans_joghurt_curry}
			...
			\subsection{Bosnische Pita (Sirnica)}	\label{bosn_pita}
			...
			\subsection{Lasagne}	\label{lasagne}
				...
				\subsection{Burger}	\label{burger}
...
\begin{tabularx}{\textwidth}{r|L}
	...
	\subsection{Bratnudeln}	\label{bratnudeln}
	...
	\subsection{Bratreis}	\label{bratreis}
...
\newpage
	...
	\subsection{Garam Masala}	\label{garam_masala}
	...
	\subsection{Pav Bhaji Masala}	\label{pav_bhaji_masala}
...
\newpage
		...
		\subsection{Pfannkuchen}	\label{pfannkuchen}
		...
		\subsubsection{Bananen-Pancakes}	\label{Bananen-Pancakes}
		...
		\subsection{Dampfnudeln}	\label{dampfnudeln}

		\begin{tabularx}{\textwidth}{r|L}
									& 	\includegraphics[height = 5cm]{media/dampfnudel.jpg}	\\
									&	\\
			\textbf{Beschreibung}	&	Dampfnudeln findet man auch auf dem Weihnachtsmarkt, aber sie zuhause selber machen zu können macht den Genuss einfach flexibler.\\
									&	\\
			\begin{tabular}[t]{rr}
				\textbf{Zutaten}	\\
				Für 680 g 			\\
		...
		\subsection{Vanille-Sauce und -Pudding}	\label{vanillesosse}
		...
		\subsection{Waffeln}	\label{waffeln}
	...
	\subsection{Grießbrei oder Grießpudding}	\label{grießbrei}
	\begin{tabularx}{\textwidth}{r|L}
 ...
 \subsection{Milchreis}	\label{milchreis}
 ...
 % Karamell
	...
	\subsection{Karamell}	\label{karamell}
	...
	\subsection{Gebrannte Mandeln}	\label{gebrannte_mandeln}
...
\subsection{Früchtequark}	\label{fruchtquark}
...
\section{Snacks}
	...
	\subsection{Pizzabrötchen}	\label{pizzabroetchen}
...
\newpage
	...
	\subsection{Grundteige}
	\newpage

		% Rezept für Mürbeteig

		\subsubsection{Mürbeteig} \label{muerbeteig}
		...
		\subsubsection{Hefeteig} \label{hefeteig_grundrezept}
	...
	\subsection{Chiabatta}	\label{shiabatta}
	...
	% \begin{tabularx}{\textwidth}{r|L}						
		...
		\subsection{Zwiebelkuchen}	\label{zwiebelkuchen}
	...
	\subsection{Süßgebäck}
	\newpage

		% Rührkuchen

		\subsubsection{Rührkuchen}	\label{ruehrkuchen}
		...
		\subsubsection{Bananenbrot}	\label{bananenbrot}
		...
		\subsubsection{Pumpkin-Pie}	\label{pumpkin_pie}
		...
		\subsubsection{Gedeckte Apple-Pie ($\pi$-Day-Pie)}
	...
	%								&	\\	
		...
		\subsubsection{Hefezopf}	\label{Hefezopf}
		...
		\subsubsection{Teigschnecken}	\label{teigschnecken}
		...
		\begin{tabularx}{\textwidth}{r|L}	
			...
			\end{tabular}			&	\begin{enumerate}[]
											...
											\item Ziehe (nur notfalls rollen) jedes Stück in ein Rechteck von ca. 35 x 20 cm.
		...
		\subsubsection{Muffins}	\label{muffins}
		...
		\subsubsection{Pflaumenkuchen}	\label{pflaumenkuchen}
		...
		\subsubsection{Schoko-Creme-Nuss-Kuchen}	\label{schokoCremeNussKuchen}
		...
		\subsubsection{Veganer Karottenkuchen}	\label{Karottenkuchen}
...
\subsection{Liste von Gemüse nach Garzeit} \label{anhang:gemueseliste}
