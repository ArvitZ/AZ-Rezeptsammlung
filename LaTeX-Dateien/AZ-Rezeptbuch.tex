...
=======
				\textbf{Passendes}		&	\begin{itemize}[nosep]
												\item Basmatireis 
												\item Naan-Fladenbrot \ref{fladenbrot}
>>>>>>> c29e116 (apply old changes)
											\end{itemize}	\\
				% für zweiseitiges Rezept entkommentieren!
			\end{tabularx}
			\newpage
...
=======
		...
		\end{tabular}			&	\begin{enumerate}[nosep]
										\item Vermische den Zucker mit der Sahne, gib alles in einen leicht zu spülenden Topf und erhitze es, bis es ordentlich kocht und eine leichte Verfärbung sehen lässt.
										\item Koche die Karamellmasse so lange, bis das Karamell die gewünschte Färbung und Konsistenz hat. Mit längerer Kochzeit (15-20 min) wird das Karamell-Fudge fester und zäher, wobei es bei kurzer Kochzeit (5-10 min) brüchig und weich ist. 
>>>>>>> c29e116 (apply old changes)
									\end{enumerate}	\\
	\end{tabularx}
